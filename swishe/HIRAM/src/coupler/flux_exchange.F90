...
!---- put atmosphere quantities onto exchange grid ----
  ...
  call put_to_xgrid (Atm%vort850,   'ATM', ex_vort850,   xmap_sfc, remap_method=remap_method)
  call put_to_xgrid (Atm%rh250,   'ATM', ex_rh250,   xmap_sfc, remap_method=remap_method)
