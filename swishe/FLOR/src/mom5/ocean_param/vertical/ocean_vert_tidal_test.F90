...
! </INFO>
!
!<NAMELIST NAME="ocean_vert_tidal_test_nml">
...
!  </DATA> 
!
!  <DATA NAME="repro_legacy_const_cdbot" TYPE="logical">
...
!#######################################################################
! <SUBROUTINE NAME="ocean_vert_tidal_test_init">
!
! <DESCRIPTION>
...
!#######################################################################
! <SUBROUTINE NAME="vert_mix_tidal_test">
!
! <DESCRIPTION>
