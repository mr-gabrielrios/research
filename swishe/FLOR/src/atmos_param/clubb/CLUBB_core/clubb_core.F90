...
!-----------------------------------------------------------------------
! $Id: clubb_core.F90,v 20.0 2013/12/13 23:09:35 fms Exp $
!-----------------------------------------------------------------------
module clubb_core
...
!-----------------------------------------------------------------------
  ...
  subroutine advance_clubb_core &
             ( l_implemented, dt, fcor, sfc_elevation, &
               ...
               sclrm,   &
#ifdef GFDL
               rcp2_zt, sclrm_trsport_only,  &  ! h1g, 2010-06-16
#endif
    ...
    real( kind = core_rknd ), intent(inout), dimension(gr%nz) :: rcp2_zt ! r_c'^2 (on thermo. grid)         [(kg^2)/(kg^2)]
#endif
