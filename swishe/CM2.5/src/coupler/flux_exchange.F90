...
character(len=4), parameter :: mod_name = 'flux'
  ...
  integer :: id_drag_moist,  id_drag_heat,  id_drag_mom,     &
     ...
     id_t_surf, id_t_flux, id_r_flux, id_q_flux, id_slp, id_swfq,     &
     ...
     id_q_ref,  id_q_ref_land, id_q_flux_land, id_rh_ref_cmip, id_vort850
...
! put atmosphere bottom layer tracer data onto exchange grid
  ...
  call surface_flux (&
       ...
       ex_rh250, ex_rh500, ex_rh700, ex_rh850, ex_swfq)
