...
!-----------------------------------------------------------------------
! $Id: parameters_tunable.F90,v 20.0 2013/12/13 23:10:13 fms Exp $
!===============================================================================
...
! ---> h1g, 2013-03-22, add a namelist variable: altitude_threshold_GFDL
  real( kind = core_rknd ), public :: &
    altitude_threshold_GFDL = 100.0 !  Altitude (in meters) above which damping should occur
! <--- h1g
...
!$omp threadprivate(l_prescribed_avg_deltaz)
  ...
  namelist /initvars/  & 
    ...
    mult_coef, taumin, taumax, mu, Lscale_mu_coef, Lscale_pert_coef, altitude_threshold_GFDL
