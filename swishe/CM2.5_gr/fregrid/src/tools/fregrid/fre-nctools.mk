...
#CLIBS     := -lnetcdf -lhdf5_hl -lhdf5 -lz -limf $(CLIBS2)   #GAV 19-7-2017
#CLIBS     := -L${NETCDF_HOME}/lib64 -L${HDF5_HOME}/lib64 -lnetcdf -lhdf5_hl -lhdf5 -lz -limf $(CLIBS2) $(STATIC)
#CLIBS     := -L${NETCDF_HOME}/lib64 -L${HDF5_HOME}/lib64 -lnetcdf -lhdf5_hl -lhdf5 -lz -limf $(CLIBS2) $(STATIC)
CLIBS     :=  -L${NETCDF_HOME}/lib64 -L${HDF5_HOME}/lib64  -lnetcdf -lz -limf $(CLIBS2) -lhdf5
